...
# heart_disease_project documentation build
...
from heart_disease_project import __version__ as release

# -- Project information -----------------------------------------------------

project = "heart_disease_project"
author = "Kedro"
...
htmlhelp_basename = "heart_disease_projectdoc"
...
latex_documents = [
    (
        master_doc,
        "heart_disease_project.tex",
        "heart_disease_project Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "heart_disease_project",
        "Project heart_disease_project codebase.",
        "Data-Science",
    )
]
